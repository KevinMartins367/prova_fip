									...
									<div class="row">
										...
										<div class="col-md-6 mb-3">
											<div class="form-group">
												...
												<div class="controls">
													<input id="cnpj" class="form-control" name="cnpj" type="text" maxlength="45" placeholder="XX.XXX.XXX/XXXX-XX" required data-validation-required-message="Campo obrigatório">
												</div>
											</div>
										</div>
									</div>
